const logger = require('log4js').getLogger('Fgc20Controller Controller');
...
class Qrc20Controller {
    ...
    fetchTransfers(cb, data) {
        ...
        return InsightApiRepository.fetchFgc20Transfers(contractAddress, {
            offset: offset,
            limit: limit,
            addresses: addresses
        }, (err, data) => {
...
Controllers.fgc20 = new Fgc20Controller();