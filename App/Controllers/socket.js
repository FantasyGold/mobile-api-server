...
const FantasyGoldRoomEvents = require('../Components/SocketEvents/FantasyGoldRoomEvents');
...
class SocketController {
    ...
    initSocketEvents() {
        ...
        this.events.fantasygoldRoomEvents = new FantasyGoldRoomEvents(this.socket, this.socketClient);
    ...
    socketHandler(socket) {
        ...
        socket.on('disconnect', () => {
            ...
            this.events.fantasygoldRoomEvents.unsubscribeAddress(socket, null);
    ...
    subscribe_balance_change(socket, addresses, options) {
        ...
        this.events.fantasygoldRoomEvents.subscribeAddress(socket, addresses);
    ...
    unsubscribe_balance(socket, addresses, options) {
        ...
        this.events.fantasygoldRoomEvents.unsubscribeAddress(socket, addresses);
