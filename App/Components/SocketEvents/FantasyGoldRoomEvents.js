...
const logger = require('log4js').getLogger('FantasyGoldRoomEvents Socket Events');
...
class FantasyGoldRoomEvents {
    ...
    initRemoteSocket() {
        ...
        this.socketClient.on('connect', () => {
            ...
            this.subscribeRemoteFantasyGoldRoom();
        });
        ...
        this.subscribeToFantasyGoldBlock();
        this.subscribeToFantasyGoldTrx();

    }

    subscribeToFantasyGoldBlock() {

        this.socketClient.on('fantasygold/block', (data) => {
    ...
    subscribeToFantasyGoldTrx() {

        this.socketClient.on('fantasygold/tx', (data) => {
    ...
    subscribeRemoteFantasyGoldRoom() {
        this.socketClient.emit('subscribe', 'fantasygold');
    }
...
module.exports = FantasyGoldRoomEvents;