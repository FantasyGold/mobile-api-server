let fantasygoldcore = require('fantasygoldcore-lib');
let _ = fantasygoldcore.deps._;
let PrivateKey = fantasygoldcore.PrivateKey;
let PublicKey = fantasygoldcore.PublicKey;
let Address = fantasygoldcore.Address;
let BufferWriter = fantasygoldcore.encoding.BufferWriter;
let ECDSA = fantasygoldcore.crypto.ECDSA;
let Signature = fantasygoldcore.crypto.Signature;
let sha256sha256 = fantasygoldcore.crypto.Hash.sha256sha256;
let $ = fantasygoldcore.util.preconditions;
